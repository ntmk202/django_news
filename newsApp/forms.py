...
class UpdateProfile(UserChangeForm):
    username = forms.CharField(max_length=250,help_text=_("The Username field is required."))
    email = forms.EmailField(max_length=250,help_text=_("The Email field is required."))
    first_name = forms.CharField(max_length=250,help_text=_("The First Name field is required."))
    last_name = forms.CharField(max_length=250,help_text=_("The Last Name field is required."))
    ...
    def clean_current_password(self):
        if not self.instance.check_password(self.cleaned_data['current_password']):
            raise forms.ValidationError(f"_('Password is Incorrect')")
...
class savePost(forms.ModelForm):
    ...
    class Meta():
        model = models.Post
        fields = ('user', 'category', 'title','Description', 'content', 'banner_path', 'status',)
